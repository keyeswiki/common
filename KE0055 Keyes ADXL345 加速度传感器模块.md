...
- 方框输入“Adafruit ADXL345”，选择“Adafruit ADXL345”，点击“安装”。

  ![](./media/image-20250813141912876.png)

- 如果出现以下界面，选择“全部安装”。

  ![](./media/image-20250813142007735.png)
...
**如果安装 Adafruit_ADXL345 库后(代码上传成功不用安装)，上传代码报错，请按如下安装Wire库。**
